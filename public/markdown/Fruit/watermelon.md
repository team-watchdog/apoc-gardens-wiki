...
**Scientific name:** _Citrullus lanatus_
...
## Description:
Watermelon (_Citrullus lanatus_) is a flowering plant with a vine-like appearance native to Western Africa. Watermelon bears fruit that are widely cultivated and consumed across the world. Watermelon grow in tropical and temperate climates and requires warmth to grow. There are 1000 varieties around the world.
...
## Varieties
According to botanical characteristics, watermelon varieties can be divided into two main groups:
1. Sweet Melon: Types with more sweetness, including Musk Melon, Rock Melon, and Cantaloupe.
2. Water Melon: The common type in Sri Lanka, with less sweetness and higher water content in the pulp.

The "Thilini" variety, introduced by the Department of Agriculture, has become very popular in Sri Lanka. It's known as "Sugar Baby" in the foreign market. "Thilini" can withstand dry conditions better than other varieties. It produces dark green, round fruits that are almost uniform in size, weighing about 2.5-3.0 kg. The pulp of well-ripened fruits is delicious and pink-red in color.
