...
**Sri Lankan name:** Salada kola (Sinhala) | Kīrai (Tamil)
**Scientific name:** _Lactuca sativa_
...
**Pest type:**
- Root-eating caterpillars
- Cutworms
- Aphids
- Slugs and Snails

**Symptoms:**
- **Root-eating caterpillars:** Larvae damage roots and lower stem parts.
- **Cutworms:** Caterpillars cut seedlings at the base.
- **Aphids:** Curled or distorted leaves.
- **Slugs and Snails:** Holes in leaves.

**Control method:**
- **Root-eating caterpillars:** Capture adults using yellow or blue sticky traps.
- **Cutworms:** Inspect crop and apply recommended pesticides for severe damage.
- **Aphids:** Use neem oil or soap sprays.
- **Slugs and Snails:** Set up beer traps or use wood ash barriers.
...
**Symptoms:**
- **Soft rot:** Rotting starts from lower leaves and moves upwards.
- **Sclerotium rot:** White mold growth under humid conditions.
- **Damping off:** Seedling collapse.
- **Downy mildew:** Yellowing leaves with white fuzzy growth.

**Management:**
- **Soft rot:** Proper spacing and preventing lower leaves from touching the soil. Apply polythene mulch to reduce infection.
- **Sclerotium rot:** Improve drainage and maintain proper spacing.
